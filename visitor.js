...
async function getVisitorIPInfo() {
    try {
        const response = await fetch(
            "https://api.ipgeolocation.io/ipgeo?apiKey=05c4ab68beed48fa9e37b6797efe30ab"
        );
...
async function saveVisitorCount(countryCode) {
    try {
        const response = await fetch(
            "https://soft-ossified-uranium.glitch.me/api/saveVisitorCount",
            {
                method: "POST",
...
async function fetchVisitorCounts() {
    try {
        const response = await fetch(
            "https://soft-ossified-uranium.glitch.me/api/getVisitorCounts"
        );
        const data = await response.json();
        return data;
    } catch (error) {
