...
//     try {
//         const response = await fetch("https://api-visitor-jacob.vercel.app/api/saveVisitorCount", {
//             method: "POST",
...
//     try {
//         const response = await fetch("https://api-visitor-jacob.vercel.app/api/getVisitorCounts");
//         const data = await response.json();
//         return data;
//     } catch (error) {
//         console.error(error);
